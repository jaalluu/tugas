...
WebUI.setText(findTestObject('Object Repository/user/login/input_OR_username'), username)

	def passwd = (CryptoUtil.encode(CryptoUtil.getDefault(password)))
	
WebUI.setEncryptedText(findTestObject('Object Repository/user/login/input_Username_password'), passwd)
